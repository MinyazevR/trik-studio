...
if [ "$ID" == "altlinux" ]; then
    ...
    apt-get update && apt-get install -y gcc-c++ curl xz p7zip-standalone rsync libusb-devel libudev-devel python3-dev zlib-devel make ccache python3-module-pip time
